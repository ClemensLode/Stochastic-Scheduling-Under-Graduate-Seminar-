...
Hier im Speziellen m"ochte ich auf vier F"alle aus diesem Bereich eingehen die mit der Abarbeitung von Jobs auf ein oder mehreren Prozessoren zu tun haben. Dabei ben"otigt jeder Job eine gewisse Zeit \(X_{j}\), die eine Exponentialverteilung besitzt. 
...
\end{itemize}
Im Weiteren gehen wir au"serdem davon aus, dass zum Zeitpunkt \emph{0} bereits ein Job \emph{0} auf dem Prozessor liegt.
